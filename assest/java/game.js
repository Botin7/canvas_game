...
var hero = {
  speed: 230 // movement speed of hero in pixels per second
};
var monster = {};
...
var update = function (modifier) {
  ...
  if (39 in keysDown) { // Player is holding right key
   ...
   if(hero.y + sideLenght > canvas.height) {
    hero.y = canvas.height - sideLenght;
  }
    if(hero.x + sideLenght > canvas.width) {
    hero.x = canvas.width - sideLenght;
  }
  if(hero.y + sideLenght > canvas.height) {
    hero.y = canvas.height - sideLenght;
  }
...
var render = function () {
  ...
  ctx.fillText("You had caught: " + monstersCaught, 19, 20);
